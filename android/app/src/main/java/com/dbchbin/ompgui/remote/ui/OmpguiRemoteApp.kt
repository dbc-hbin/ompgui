        ...
        Surface {
            when (val screen = state.screen) {
                ...
                is RemoteScreen.Sessions -> SessionListScreen(
                    ...
                    worktreesError = state.worktreesError,
                ...
                is RemoteScreen.Chat -> {
                    ...
                    ChatScreen(
                        ...
                        onRefreshQueue = viewModel::refreshMessageQueue,
                        onRecallQueuedMessage = viewModel::recallQueuedMessage,
                        onDeleteQueuedMessage = viewModel::deleteQueuedMessage,
                        onPromoteQueuedMessage = viewModel::promoteQueuedMessage,
                        onConsumeRecalledDraft = viewModel::consumeRecalledDraft,
