...
const { isRelayUpgradeOriginAllowed, handleRelayUpgrade } = await jiti.import("./gateway.ts");
...
test("handleRelayUpgrade is exported for the HTTP upgrade patch", () => {
  assert.equal(typeof handleRelayUpgrade, "function");
});
