...
test("ompgui options prefer new environment names", () => {
  ...
  assert.deepEqual(options, { port:"1234", hostname:"0.0.0.0", password:"secret", openBrowser:true });
});
...
test("CLI values override environment", () => {
  ...
  assert.deepEqual(options, { port:"9", hostname:"localhost", password:"cli", openBrowser:false });
});
