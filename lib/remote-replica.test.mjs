...
test("projects only bounded text from safe display roles", () => {
  const snapshot = projectRemoteReplica({
    ...
    messages: [
      null,
      "untrusted RPC value",
      { role: "user", content: [{ type: "text", text: { secret: "not text" } }] },
      { role: "custom", customType: {}, display: true, content: "malformed custom" },
      { role: "custom", customType: "visible", display: "true", content: "unvalidated visibility" },
      {
        role: "user",
        content: [
