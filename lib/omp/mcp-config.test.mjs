...
import { mkdirSync, mkdtempSync, rmSync, writeFileSync, openSync, closeSync, utimesSync, existsSync, symlinkSync, statSync } from "node:fs";
...
const { deleteMcpServer, mergeMcpServers, parseMcpListOutput, readDiscoveredMcpServers, readMcpConfig, readUserMcpConfig, redactMcpServer, validateMcpServer, writeMcpServer } = await jiti.import("./mcp-config.ts");
