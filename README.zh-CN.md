...
> **Android APK（Android 12+）** — 使用 Kotlin 配套应用连接远程 ompgui 服务器，并查看最新会话的只读离线快照。[下载 ompgui Remote v0.7.7](https://github.com/dbc-hbin/ompgui/releases/download/v0.7.7/ompgui-remote-v0.7.7.apk) · [发行说明](https://github.com/dbc-hbin/ompgui/releases/tag/v0.7.7)
