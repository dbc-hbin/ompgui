...
> **Android APK (Android 12+)** — Kotlin 보조 앱으로 원격 ompgui 서버에 연결하고, 최신 세션의 읽기 전용 오프라인 스냅샷을 이용할 수 있습니다. [ompgui Remote v0.7.0 다운로드](https://github.com/dbc-hbin/ompgui/releases/download/v0.7.0/ompgui-remote-v0.7.0.apk) · [릴리스 노트](https://github.com/dbc-hbin/ompgui/releases/tag/v0.7.0)
