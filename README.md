...
> **Android APK (Android 12+)** — Use the Kotlin companion app to connect to a remote ompgui server, with a read-only offline snapshot of the latest session. [Download ompgui Remote v0.7.3](https://github.com/dbc-hbin/ompgui/releases/download/v0.7.3/ompgui-remote-v0.7.3.apk) · [Release notes](https://github.com/dbc-hbin/ompgui/releases/tag/v0.7.3)
